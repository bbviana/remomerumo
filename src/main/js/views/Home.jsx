        ...
        <Nav right eventKey={0}> {/* This is the eventKey referenced */}
            ...
            <Tabs defaultActiveKey={1}>
	            <Tab eventKey={1} title="Pessoas"><p>&nbsp;</p>
	            	...
	            	<p><strong> <Glyphicon glyph="user"/>&nbsp;&nbsp;Responsáveis:</strong> São as pessoas responsáveis pelos alunos do IRMR, um aluno pode ter em seu cadastro mais de um responsável, este cadastro é apenas paraa aumentar a ratreabilidade sobre as crianças.</p>
	            ...
	            <li><strong>Execução:</strong> Aqui contamos com a lista de chamadas</li>
	            </Tab>
